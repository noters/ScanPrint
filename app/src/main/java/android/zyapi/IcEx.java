...
public class IcEx {
    ...
    private byte mIcExPowerPin = 0x44;//PE4-->44
    ...
    public void init(){
        ...
        mApi.gpioControl(mIcExPowerPin, 0, 1);// power on
        mApi.extendSerialInit(4, 9, 1, 1, 1, 1);
    }
    ...
    public void close(){
        ...
        if(mApi!=null){
            mApi.extendSerialClose(4);
            mApi.gpioControl(mIcExPowerPin, 0, 0);// power off
        }
    }
    ...
    /**
     * SLE4442 密码为 3 字节,默认为”FFFFFF”.SLE4428 密码为 2 字节,默认为”FFFF”
     * @param key
     * @param keyLength
     * @return
     */
